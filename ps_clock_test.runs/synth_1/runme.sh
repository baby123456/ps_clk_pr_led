...
HD_PWD='E:/fastAcess/recent/xen_on_ARM/PR/ps_clock_test/ps_clock_test/ps_clock_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_clock_led_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ps_clock_led_wrapper.tcl
