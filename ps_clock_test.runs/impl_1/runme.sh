...
HD_PWD='E:/fastAcess/recent/xen_on_ARM/PR/ps_clock_test/ps_clock_test/ps_clock_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ps_clock_led_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ps_clock_led_wrapper.tcl -notrace
